...
(new PageHeader(
    ...
    Description: "Dibujar un Formulario con Selects relacionados (Region > Comuna)"
))->Draw();
                ...
                [
                    ...
                    new FormRowFieldSelect(
                        ...
                        SelectDefinition: new FormRowFieldSelectDefinition(
                            ...
                            DisplaySearch: false,
                            OptionAttributeNames: ['IdRegion', 'Descripcion'],
                    ...
                    new FormRowFieldSelect(
                        ...
                        SelectDefinition: new FormRowFieldSelectDefinition(
                            ...
                            Description: 'Descripcion',
                            DisplaySearch: true,
                            OptionAttributeNames: ['IdComuna', 'Descripcion'],
                            // LinkToList, implica que esta lista será refrescada con cada cambio
                            // en la "lista enlazada"
                            LinkToList: 'IdRegion',
                            // Se debe aseguar la existencia del servicio "ExampleSvc" en los
                            // servicios definidos de la aplicación (public/Services/...)
                            // y que dicho servicio cuente con la funcion GetByRegion
                            JSRefreshService: ['ExampleSvc', 'GetByRegion']
                        )
                    ),
                ],
            ],
