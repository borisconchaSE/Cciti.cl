                ...
                <div class="col-sm-12">
                    <div class="hpanel plan-box hyellow active">
                        <div class="panel-heading hbuilt text-center">
                            <h4 class="font-bold">Política de privacidad</h4>
                        </div>
                        <div class="panel-body">
                        <div><strong>POLÍTICA DE PRIVACIDAD</strong></div>
                            <div><small>Shutdown SpA</small></div>
                            <p>La presente Política de Privacidad establece los términos en que Shutdown SpA usa y protege la información que es
                                proporcionada por sus usuarios al momento de utilizar su sitio web y su aplicación móvil. Esta compañía está
                            ...
                            <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para
                                ...
                                cualquier momento.</p>
                            <p>Shutdown SpA está altamente comprometida para cumplir con el compromiso de mantener su información segura. Usamos los
                            ...
                            <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta
                                ...
                                menos de que usted así lo quiera y la proporcione directamente.<br>
                            ...
                            <p>Este sitio web pudiera contener enlaces a otros sitios que pudieran ser de su interés. Una vez que usted de clic en
                                estos enlaces y abandone nuestra página, ya no tenemos control sobre al sitio al que es re dirigido y por lo tanto
                            ...
                            <p>Shutdown SpA Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
                                momento.</p>
                        </div>
                    </div>
                </div>
