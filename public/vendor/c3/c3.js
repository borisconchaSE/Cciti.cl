(function (window) {
    ...
    c3_chart_internal_fn.initWithData = function (data) {
        ...
        // Define regions
        main = $$.main = $$.svg.append("g").attr("transform", $$.getLocalize('main'));
    ...
    c3_chart_internal_fn.transformMain = function (withTransition, transitions) {
        ...
        (withTransition ? $$.main.transition() : $$.main).attr("transform", $$.getLocalize('main'));
        xAxis.attr("transform", $$.getLocalize('x'));
        yAxis.attr("transform", $$.getLocalize('y'));
        y2Axis.attr("transform", $$.getLocalize('y2'));
        $$.main.select('.' + CLASS.chartArcs).attr("transform", $$.getLocalize('arc'));
    };
    ...
    c3_chart_internal_fn.initLegend = function () {
        ...
        $$.legend = $$.svg.append("g").attr("transform", $$.getLocalize('legend'));
    ...
    c3_chart_internal_fn.transformLegend = function (withTransition) {
        var $$ = this;
        (withTransition ? $$.legend.transition() : $$.legend).attr("transform", $$.getLocalize('legend'));
    };
    ...
    c3_chart_internal_fn.initArc = function () {
        ...
        $$.arcs = $$.main.select('.' + CLASS.chart).append("g")
            ...
            .attr("transform", $$.getLocalize('arc'));
        $$.arcs.append('text')
    ...
    c3_chart_internal_fn.initSubchart = function () {
        var $$ = this, config = $$.config,
            context = $$.context = $$.svg.append("g").attr("transform", $$.getLocalize('context'));
        ...
        $$.axes.subx = context.append("g")
            ...
            .attr("transform", $$.getLocalize('subx'))
    ...
    c3_chart_internal_fn.transformContext = function (withTransition, transitions) {
        ...
        $$.context.attr("transform", $$.getLocalize('context'));
        subXAxis.attr("transform", $$.getLocalize('subx'));
    };
