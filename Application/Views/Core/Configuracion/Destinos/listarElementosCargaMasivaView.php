    ...
    new JSTableCell(
       ...
       JSDataFilter : [
        new JSTableScriptFilter(
            ...
            Script: [
                '
                if (element.IdTipoEstadoDestino == 2) {
...
$display->AddTableFromCollection(
    tableKey: 'tbListaElementosCargaMasiva',
    ...
    CustomDataTable : new DataTableSettingsFilterDto(
        ...
        DrawTableCallback   : [
            ...
            if(window.selectedTeams != null){
                ...
                let parent      = $("#tbListaElementosCargaMasiva");
...
(
    new Container(
        Children:[
            new Panel(
                Header: new Text('Lista Destinos Generados'),
                Body: new Container(
                    Children: [
                        $display->Widgets()['tbListaElementosCargaMasiva'],
                        new Container(
                            Classes     :['hide'],
                            Key         : 'qrcontainer',
                            Children    :[
                                new Html(
                                    '
                                    <img src="data:image/png;base64, '.base64_encode(file_get_contents(SITE_URL . "/assets/qrcodes/clientes/1/qrcode_equipo_91.png")).'">
                                    '
                                ),
                                new Html(
                                    '
