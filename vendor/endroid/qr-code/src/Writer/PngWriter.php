...
final class PngWriter implements WriterInterface, ValidatingWriterInterface
{
    public function write(QrCodeInterface $qrCode, LogoInterface $logo = null, LabelInterface $label = null, array $options = []): ResultInterface
    {
        ...
        if ($label instanceof LabelInterface) {
            $result = $this->addLabel($label, $result, $qrCode);
        }
    ...
    private function addLabel(LabelInterface $label, PngResult $result , $qrCode = null ): PngResult
    {
        $targetImage = $result->getImage();

        $margin     = $qrCode->getMargin() / 2;

        $labelImageData = LabelImageData::createForLabel($label,$margin);
        ...
        $y = imagesy($targetImage) - $label->getMargin()->getBottom() - $margin;
